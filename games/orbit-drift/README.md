...
Built on matter-js for physics and collision, with a custom N-body gravity step layered on top. Levels are generated from screen dimensions (`Layout.screen`) with safe-space margins around every spawn so orbs stay reachable and nothing spawns inside a planet.
