...
The generated game is a fully wired application project: uses the shared [engine](../../packages/engine/README.md) for rendering, lifecycle, base game structure. After generation, run `bun install` to link workspace dependencies.
